...
namespace EnterInsideShooping.Controllers
{
    public class NewsManagementController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NewsId,UserId,Title,ShortDescription,Content,CreatedDate,Status,Images")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NewsId,UserId,Title,ShortDescription,Content,CreatedDate,Status,Images")] News news)
        {
            if (ModelState.IsValid)
            {
